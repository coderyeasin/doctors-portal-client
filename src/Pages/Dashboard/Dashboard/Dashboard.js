...
import DashboardHome from '../DashoardHome/DashboardHome';
...
function Dashboard(props) {
  ...
  const drawer = (
    <div>
      ...
      <Link to="/appoinment"><Button color="inherit">Appointment</Button></Link> <br />
    ...
    <Box sx={{ display: 'flex' }}>
      ...
      >
        ...
        <Switch>
            ...
            <Route path={`${path}/payment/:appointId`}>
            <Payment></Payment>
            </Route>
