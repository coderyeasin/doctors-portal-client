...
const BookingModal = ({openBooking, handleCloseBooking, booking, date, setBookingSuccess}) => {
  ...
  // const [bookingInfo, setBookingInfo] = useState({ intializeInfo }) //its create another object

  const [bookingInfo, setBookingInfo] = useState(intializeInfo) //solved
  ...
  const handleOnBlur = e => {
    ...
    const handleBooked = (e) => {
      ...
      //--send to the server
      fetch('https://radiant-hamlet-62916.herokuapp.com/appointments', {
        method: 'POST',
        headers: {
